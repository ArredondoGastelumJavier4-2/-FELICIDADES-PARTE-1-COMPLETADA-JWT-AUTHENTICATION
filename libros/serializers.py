...
class AutorSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Autor
        fields = ['id', 'nombre', 'apellido', 'nombre_completo',   'fecha_nacimiento', 'pais_origen', 'biografia', 'foto', 'total_libros', 'fecha_creacion']
        read_only_fields = ['id', 'fecha_creacion']
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'username', 'email', 'first_name', 'last_name',  'is_staff', 'date_joined', 'total_prestamos']
