...
def google_oauth_redirect(request):
    ...
    Redirige directamente a Google con los parámetros correctos.
    """
    google_config = settings.SOCIALACCOUNT_PROVIDERS["google"]["APP"]
    ...
    params = {
        ...
        "scope": " ".join(scopes),
        "response_type": "code",
        # Nota: NO ponemos prompt=consent para que no te obligue a elegir cuenta cada vez.
        # Si quieres forzar que el usuario elija cuenta, usa:
        # "prompt": "select_account",
        #
        # Si en el futuro necesitas refresh token:
        # "access_type": "offline",
        # y SOLO una vez (o cuando cambies permisos) podrías usar:
        # "prompt": "consent",
    }
